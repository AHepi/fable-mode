...
**Don't narrate the structure, and ration the tics.** Classic style shows the reader the thing; it does not stand beside the thing announcing it. Cut the self-describing scaffolding: *This module is about…*, *Here is the question this section exists to answer*, *A warning before the two theories*, *Now do the thing this whole module exists for*. Just do it. Three devices in particular go stale fast when a piece, or a whole course, leans on them: the **rhetorical question** (*How does a made thing come to feel natural?*), **direct second-person address** (*you stood, you worked out, you pocketed*), and the **dramatic one-clause fragment** (*Built, not grown.*). Each earns its place once or twice for emphasis. Used as a default move, paragraph after paragraph, they become a mannerism the reader hears louder than the content. Keep a tight budget for all three, and vary how each passage opens and turns rather than reaching for the same gesture every time.
