...
Everything so far is something you can hold. Now we attach the word. The property at stake has a name, so let's bridge to it carefully — straight from the tracing experiment, because that experiment *is* the definition, only without the word attached yet.
