...
The headline almost writes itself: **"Eating Ice Cream Linked to Drowning."** And a chart backs it up — the more ice cream a town sells, the more people drown that month, and the cloud of points leans hard up to the right. You could thread a best-fit line through that cloud, just as we did earlier, and read off a confident slope. So should the lifeguards confiscate the cones?
...
Here is the line to carry out of this course: **correlation isn't causation.** Two measurements can track each other beautifully — tightly enough that the best-fit line we met earlier looks authoritative — and still, neither one need cause the other.
...
The data are real enough. Plot a town's monthly ice cream sales against its monthly drownings and the cloud tilts upward: high-ice-cream months are high-drowning months. The correlation is strong: a tight, positive relationship, the cloud hugging a rising line.
