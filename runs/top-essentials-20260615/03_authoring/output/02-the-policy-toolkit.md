...
TOP proposes `[verify 2026 rate]` 1.75% per year on urban land value and 0.5% on rural land value, with a **deferral option** for owners who are land-rich but cash-poor — the bill accrues against the title and is paid when the property sells `[verify: interest on deferred balances]`.
