...
**1.** In I-JEPA, the context encoder $f_c$ receives the image with target blocks removed. Why must the target blocks be *removed* from the context rather than ignored — for instance, by masking them during the attention computation?
