...
So far we have learned to read one pile of numbers: its shape, its center, how wide it scatters. We left off on the crack that pile sat over — every pile we study is really a handful scooped from something far larger we cannot see whole. Here is the handful.
