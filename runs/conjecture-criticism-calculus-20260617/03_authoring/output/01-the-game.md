...
This machinery was built to prove something: that creativity — the generation of genuinely new conjectures — is not merely useful but provably unavoidable for any system that sustains inquiry. That theorem (beyond this course's scope) is what the calculus was designed to support.
