...
The construction is simple enough to show in full. Turner and colleagues introduced it in 2023 under the name activation addition. Take two contrasting prompts. Run each through the model. At some chosen layer, read off the running state for each. The *difference* of those two states is your steering vector.
